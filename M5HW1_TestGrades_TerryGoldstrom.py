...
def main():
    ...
    print('Your final average is:',findAvg,',', 'Your letter grade is:', letterGrade)

# Gather 5 Test Scores
def getScore1():
...
# Calculate average of the 5 test scores
def calc_average(score1, score2, score3, score4, score5):
    total = score1 + score2 + score3 + score4 + score5
    avg = total / 5
    return avg

# Determine the letter grade for test scores
